...
var username = '630e6445-2bf4-4016-ae17-73a7f0f7f862';
var password = 'GrE7wMbYmThY';

// corpus path /corpora/{account_id}/{corpus_name}
var corpusPath = '/corpora/mer1ob8gen1tri8/anumali';
  ...
  return function(place) {
    request.get({
      ...
      qs: {
        ...
        prop: 'extracts',
        explaintext: true,
        titles: place.book_name,
     }
   }, function(error, response, body) {
     var newDocument = {
       id: corpus + '/documents/' + place.id,
       document: {
         id: place.id,
         label: place.book_name,
         parts: [{
           name: place.author_name,
           data: place.book_content
         }]
       }
     };
